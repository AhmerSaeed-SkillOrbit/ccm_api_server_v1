...
//                    }
                    ...
                    if ($checkInsertUserId) {
                        ...
                        if ($belongTo == "superadmin_doctor") {
                            $roleCode = "doctor";
                            $emailBody = "<p><h3>Hi</h3>$email<br><br>Welcome to the Chronic Care Management system. You are registered as a Doctor into the connectcareplus. The connectcareplus is a one stop solution health solution. Please take some time and log into the portal with your registered id (https://www.connectcareplus.com).</p><br><br>";
                        } else if ($belongTo == "doctor_patient") {
                            $roleCode = "patient";
                            $emailBody = "<p><h3>Hi</h3>$email<br><br>Welcome to the Chronic Care Management system. You are registered as a Patient into the connectcareplus. The connectcareplus is a one stop solution health solution. Please take some time and log into the portal with your registered id (https://www.connectcareplus.com). The following will be the facilities. <br><br>" .
                                ...
                                "4. Review your progress against the plan and much more.</p><br>";

                        } else if ($belongTo == "doctor_facilitator") {
                            $roleCode = "facilitator";
                            $emailBody = "<p><h3>Hi</h3>$email<br><br>Welcome to the Chronic Care Management system. You are registered as a Facilitator into the connectcareplus. The connectcareplus is a one stop solution health solution. Please take some time and log into the portal with your registered id (https://www.connectcareplus.com).</p><br><br>";
                        } else {
                            $roleCode = "noRole";
                        }
